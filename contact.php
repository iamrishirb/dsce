    ...
    <div class="container">
        <div class="row d-flex contact-info">
            ...
            <div class="bg-light align-self-stretch box p-4 text-center">
                ...
                <p>	Dharamraj Singh College of Education, Ragauli Karvi, - 210205</p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
            <div class="bg-light align-self-stretch box p-4 text-center">
                <h3 class="mb-4">Contact Number</h3>
                <p><a href="tel:+91 9721 888 666">+91 9721 888 666</a></p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
            <div class="bg-light align-self-stretch box p-4 text-center">
                <h3 class="mb-4">Email Address</h3>
                <p><a href="mailto:info@dsce.org.in">info@dsce.org.in</a></p>
                </div>
            </div>
        </div>
    </div>
